...
<body>
    ...
    <section class ="contents">
	    <div class="cont left">
	    	...
	    	<ul>
	    		<li onclick="location.href='/vitabucket/admin/order'" class="li_color">주문리스트(전체)</li>
	    ...
	    <div class="cont right">
	    	<h4>HOME > 주문관리 > 주문리스트(전체)</h4>
		    <section>
		        <h2>주문리스트(전체)</h2>		        
	            <div class="t1">
	               <h3>주문검색</h3>		
					<form action="/vitabucket/admin/order" method="post" id="searchForm">                
						<table>
							<tr>
								<th>검색어</th>
								<td>
								    <select name="search">
								        ...
								        <option value="to_pro_name">상품명</option>
								        <option value="to_key">상품번호</option>
								        <option value="to_date">주문날짜</option>										
								    </select>
							        <input type="search" required name="search_key">
							        <button type="submit" onclick="search()">검색</button>
							        <button type="button" onclick="location.href='/vitabucket/admin/order'">전체목록</button>
								</td>
							</tr>
						</table>
					</form>
