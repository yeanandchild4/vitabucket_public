...
<head>
<meta charset="UTF-8">
<title>VitaBucket 개인정보처리방침</title>
<style>
	html,body{
...
<div class="area">
	...
	<div class="list-box">
		<ul class="list1" style="padding-left: 0">
			<li>
				총칙
			</li>
			<li>
	...
	<div class="wrap-contents">
		<strong class="subtit">1. 총칙</strong>
		<p class="contents">
		...
		<ul>
			<li>
				<span>1)</span>
				회사는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」을 비롯한 모든 개인정보보호 관련 법률규정을 준수하고 있으며, 관련 법령에 의거한 개인정보처리방침을 정하여 이용자 권익 보호에 최선을 다하고 있습니다.
			</li>
			<li>
				<span>2)</span>
				회사는 「개인정보처리방침」을 제정하여 이를 준수하고 있으며, 이를 인터넷사이트 및 모바일 어플리케이션에 공개하여 이용자가 언제나 용이하게 열람할 수 있도록 하고 있습니다.
			</li>
			<li>
				<span>3)</span>
				회사는 「개인정보처리방침」을 통하여 귀하께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
			</li>
			<li>
				<span>4)</span>
				 회사는 「개인정보처리방침」을 홈페이지 첫 화면 하단에 공개함으로써 귀하께서 언제나 용이하게 보실 수 있도록 조치하고 있습니다.
			</li>
			<li>
				<span>5)</span>
		...
		<strong class="subtit">4. 수집하는 개인정보 항목</strong>
		<p class="contents">
		...
		<p>
		<strong class="subtit">5. 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항</strong>	
		<p class="contents">
		...
		<p>
		<strong class="subtit">6. 목적 외 사용 및 제3자에 대한 제공</strong>	
		<p class="contents">
		...
		<p>
		<strong class="subtit">7. 개인정보의 열람 및 정정</strong>
		<p class="contents">
		...
		<strong class="subtit">8. 개인정보 수집, 이용, 제공에 대한 동의철회</strong>
		<p class="contents">
		...
		<strong class="subtit">9. 개인정보의 보유 및 이용기간</strong>	
		<p class="contents">
		...
		<strong class="subtit">10. 개인정보의 파기절차 및 방법</strong>
		<p class="contents">
		...
		<strong class="subtit">11. 아동의 개인정보 보호</strong>
		<p class="contents">
		...
		<strong class="subtit">12. 개인정보 보호를 위한 기술적 대책</strong>
		<p class="contents">
		...
		<strong class="subtit">13. 개인정보의 위탁처리</strong>
		<p class="contents">
		...
		<strong class="subtit">14. 의견수렴 및 불만처리</strong>
		<p class="contents">
		...
		<strong class="subtit">15. 부 칙(시행일)</strong>
		<p class="contents">
		...
		<ul>
			<li>
				1) 공고일자 : 2024년 03월 11일
			</li>
			<li>
				2) 시행일자 : 2024년 03월 11일 
			</li>
		</ul>
	</div>
</div>
